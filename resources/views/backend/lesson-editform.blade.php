	...
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-lg-5 p-0 bg-white overflow-hidden shadow-sm rounded">
				...
				<form class=" p-3" action="{{ route('dashboard.lessons.update', ['id' => $lesson->id]) }}" method="post"
					enctype="multipart/form-data">
					@csrf
					<div class="mb-3">
						<label class="form-label" for="title">Title</label>
						<input class="form-control" id="title" name="title" type="text" value="{{ $lesson->title }}"
					...
					<div class="mb-3">
						...
						<textarea class="form-control" id="description" name="description" type="text" aria-describedby="helpId">{{ $lesson->description }}</textarea>
						<small class="text-muted" id="helpId">Help text</small>
					</div>
